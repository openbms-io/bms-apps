...
import {
  isShaclValidationError,
  extractShaclErrors,
} from '../../api/types/validation-error'
import type {
  BACnetPointData,
  SemanticEquipment,
...
export function MappingPopupModal({
  ...
  const { equipmentTypes, deviceTypes, observableProperties } =
    useTemplateOptions(
      templates,
              ...
              >
                ...
                <CollapsibleContent className="space-y-4 pt-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground mb-2">
                      Which functional areas does this equipment serve or
                      control?
                    </p>
                    <SpaceMultiComboBox
                      id="domain-spaces"
